  ...
  <v-card class="ds-calendar-event-popover-card"
   ...
   <v-card-text>
     ...
     <v-list>
       ...
       <v-list-tile v-if="prompts.companyName && $dayspan.supports.companyName">
         <v-list-tile-avatar>
           <v-icon>work</v-icon>
         </v-list-tile-avatar>
         <v-list-tile-content>
           <slot name="eventCreatePopoverCompanyName" v-bind="slotData">
            ...
            <v-select
              ...
              <template slot="item" slot-scope="{ item }">
                <v-list-tile-content @click="changeSelect(item)">
...
export default {
  ...
  methods:
  {
    changeSelect (item)
    {
      this.details.companyId = item.id
